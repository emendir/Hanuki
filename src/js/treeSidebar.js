 ...
 *
 * @param {number} scaleFactor - The scale factor to apply to the base font size (16px)
 */
...
// Export public API and initialize
export {
  setFontScale
};

// Make functions available on window for access from parent frame
window.setFontScale = setFontScale;
window.Scale = setFontScale; // Legacy naming for backward compatibility
